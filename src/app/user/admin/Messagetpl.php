 ...
 */
class Messagetpl extends Admin
{
    /**
     * 消息列表
    ...
    public function add()
    {
        ...
        return ZBuilder::make('form')
            ->addFormItems([
                ...
                ['select', 'uid', '接收用户', '接收消息的用户', UserModel::where('status', 1)->column('nickname'), '', 'multiple'],
                ['select', 'role', '接收角色', '接收消息的角色', RoleModel::where('status', 1)->column('name'), '', 'multiple'],
            ])
