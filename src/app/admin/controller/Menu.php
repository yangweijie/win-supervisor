...
class Menu extends Admin
{
    ...
    public function add($module = 'admin', $pid = '')
    {
        ...
        return ZBuilder::make('form')
            ->setPageTitle('新增节点')
            ->addLinkage('module', '所属模块', '', ModuleModel::getModule(), $module, (string)url('ajax/getModuleMenus'), 'pid')
            ->addFormItems([
            ...
            ->addSelect('role', '角色', '除超级管理员外，拥有该节点权限的角色', RoleModel::where('id', '<>', 1)->column('name'), '', 'multiple')
    ...
    public function edit($id = 0)
    {
        ...
        return ZBuilder::make('form')
            ...
            ->addLinkage('module', '所属模块', '', ModuleModel::getModule(), '', (string)url('ajax/getModuleMenus'), 'pid')
