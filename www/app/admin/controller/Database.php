        ...
        switch ($group) {
            case 'export':
                ...
                $btn_export = [
                    ...
                    'href'  => (string)url('export')
                ];
                $btn_optimize_all = [
                    'title' => '优化表',
                    'icon'  => 'fa fa-fw fa-cogs',
                    'class' => 'btn btn-success ajax-post',
                    'href'  => (string)url('optimize')
                ];
                $btn_repair_all = [
                    'title' => '修复表',
                    'icon'  => 'fa fa-fw fa-wrench',
                    'class' => 'btn btn-success ajax-post',
                    'href'  => (string)url('repair')
                ];
                $btn_optimize = [
                    'title' => '优化表',
                    'icon'  => 'fa fa-fw fa-cogs',
                    'class' => 'btn btn-xs btn-default ajax-get',
                    'href'  => (string)url('optimize', ['ids' => '__id__'])
                ];
                $btn_repair = [
                    'title' => '修复表',
                    'icon'  => 'fa fa-fw fa-wrench',
                    'class' => 'btn btn-xs btn-default ajax-get',
                    'href'  => (string)url('repair', ['ids' => '__id__'])
                ];
            ...
            case 'import':
                ...
                $btn_import = [
                    ...
                    'href'  => (string)url('import', ['time' => '__id__'])
                ];
